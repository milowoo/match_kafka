...
class ChronicleQueueEventLogTest {
    ...
    void testIcebergOrderCreation() {
        PlaceMiniOrderParam miniOrder = PlaceMiniOrderParam.builder()
                .orderNo(1001L).delegateType("BUY").orderType("LIMIT")
                .delegatePrice(new BigDecimal("50000")).delegateCount(new BigDecimal("10"))
                .isIceberg(true).icebergTotalQuantity(new BigDecimal("10"))
                .icebergDisplayQuantity(new BigDecimal("2")).icebergRefreshQuantity(new BigDecimal("2"))
                .createTime(new Date()).vip(false).build();
    ...
    void testIcebergOrderMatching() {
        ...
        PlaceMiniOrderParam marketOrder = PlaceMiniOrderParam.builder()
                .orderNo(1002L).delegateType("SELL").orderType("MARKET")
                .delegateCount(new BigDecimal("1.5")).createTime(new Date()).vip(false).build();
    ...
    void testIcebergOrderRefresh() {
        ...
        PlaceMiniOrderParam marketOrder = PlaceMiniOrderParam.builder()
                .orderNo(1003L).delegateType("SELL").orderType("MARKET")
                .delegateCount(new BigDecimal("2")).createTime(new Date()).vip(false).build();
    ...
    void testIcebergOrderValidation() {
        ...
        PlaceMiniOrderParam invalidOrder = PlaceMiniOrderParam.builder()
                .orderNo(1004L).delegateType("BUY").orderType("LIMIT")
                .delegatePrice(new BigDecimal("50000")).delegateCount(new BigDecimal("10"))
                .isIceberg(true).icebergTotalQuantity(new BigDecimal("10"))
                .icebergDisplayQuantity(new BigDecimal("15")).icebergRefreshQuantity(new BigDecimal("2"))
